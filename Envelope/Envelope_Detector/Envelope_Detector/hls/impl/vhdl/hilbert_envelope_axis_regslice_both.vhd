...
entity hilbert_envelope_axis_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity hilbert_envelope_axis_regslice_both;

architecture behave of hilbert_envelope_axis_regslice_both is
