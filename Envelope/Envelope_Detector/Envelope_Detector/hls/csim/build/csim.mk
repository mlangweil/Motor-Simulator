...
HLS_SOURCES = ../../../../tb_hilbert.cpp ../../../../hilbert.cpp
...
$(ObjDir)/tb_hilbert.o: ../../../../tb_hilbert.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../tb_hilbert.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_hilbert.d

$(ObjDir)/hilbert.o: ../../../../hilbert.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../hilbert.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/hilbert.d
