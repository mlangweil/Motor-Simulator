...
// wrapc file define:
#define AUTOTB_TVIN_lowerCutoff "../tv/cdatafile/c.calculateCoefficients.autotvin_lowerCutoff.dat"
#define AUTOTB_TVOUT_lowerCutoff "../tv/cdatafile/c.calculateCoefficients.autotvout_lowerCutoff.dat"
#define AUTOTB_TVIN_upperCutoff "../tv/cdatafile/c.calculateCoefficients.autotvin_upperCutoff.dat"
...
extern "C"
void calculateCoefficients_hw_stub_wrapper(hls::sim::Byte<4>, hls::sim::Byte<4>, hls::sim::Byte<4>, void*);

extern "C"
void apatb_calculateCoefficients_hw(hls::sim::Byte<4> __xlx_apatb_param_lowerCutoff, hls::sim::Byte<4> __xlx_apatb_param_upperCutoff, hls::sim::Byte<4> __xlx_apatb_param_samplingRate, void* __xlx_apatb_param_bram)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_lowerCutoff),
#endif
  };
  port0.param = &__xlx_apatb_param_lowerCutoff;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_upperCutoff),
#endif
  };
  port1.param = &__xlx_apatb_param_upperCutoff;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_samplingRate),
#endif
  };
