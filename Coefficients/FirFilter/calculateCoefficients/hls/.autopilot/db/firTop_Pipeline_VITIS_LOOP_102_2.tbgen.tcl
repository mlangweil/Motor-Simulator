set moduleName firTop_Pipeline_VITIS_LOOP_102_2
set isTopModule 0
...
set C_modelName {firTop_Pipeline_VITIS_LOOP_102_2}
...
set C_modelArgList {
	...
	{ taps double 64 regular {array 100 { 0 1 } 1 1 }  }
	{ mean double 64 regular  }
}
set hasAXIMCache 0
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "taps_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "taps", "role": "address1" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2", "Max" : "133"}
	, {"Name" : "Interval", "Min" : "2", "Max" : "133"}
]}
...
set Spec2ImplPortList { 
	...
	taps { ap_memory {  { taps_address0 mem_address 1 7 }  { taps_ce0 mem_ce 1 1 }  { taps_we0 mem_we 1 1 }  { taps_d0 mem_din 1 64 }  { taps_address1 MemPortADDR2 1 7 }  { taps_ce1 MemPortCE2 1 1 }  { taps_q1 MemPortDOUT2 0 64 } } }
