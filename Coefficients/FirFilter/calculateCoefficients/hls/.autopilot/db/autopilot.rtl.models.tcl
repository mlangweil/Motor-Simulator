set SynModuleInfo {
  ...
  {SRCNAME calculateCoefficients_Pipeline_VITIS_LOOP_22_1 MODELNAME calculateCoefficients_Pipeline_VITIS_LOOP_22_1 RTLNAME calculateCoefficients_calculateCoefficients_Pipeline_VITIS_LOOP_22_1
    SUBMODULES {
  ...
  {SRCNAME calculateCoefficients MODELNAME calculateCoefficients RTLNAME calculateCoefficients IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME calculateCoefficients_fdiv_32ns_32ns_32_9_no_dsp_1 RTLNAME calculateCoefficients_fdiv_32ns_32ns_32_9_no_dsp_1 BINDTYPE op TYPE fdiv IMPL fabric LATENCY 8 ALLOW_PRAGMA 1}
      {MODELNAME calculateCoefficients_sitofp_32ns_32_4_no_dsp_1 RTLNAME calculateCoefficients_sitofp_32ns_32_4_no_dsp_1 BINDTYPE op TYPE sitofp IMPL auto LATENCY 3 ALLOW_PRAGMA 1}
