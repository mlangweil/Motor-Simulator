...
entity calculateCoefficients_control_s_axi is
generic (
...
architecture behave of calculateCoefficients_control_s_axi is
    ...
    constant ADDR_LOWERCUTOFF_DATA_0  : INTEGER := 16#10#;
    constant ADDR_LOWERCUTOFF_CTRL    : INTEGER := 16#14#;
    constant ADDR_UPPERCUTOFF_DATA_0  : INTEGER := 16#18#;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_LOWERCUTOFF_DATA_0 =>
                        rdata_data <= RESIZE(int_lowerCutoff(31 downto 0), 32);
                    when ADDR_UPPERCUTOFF_DATA_0 =>
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_lowerCutoff(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LOWERCUTOFF_DATA_0) then
                    int_lowerCutoff(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_lowerCutoff(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_upperCutoff(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_UPPERCUTOFF_DATA_0) then
                    int_upperCutoff(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_upperCutoff(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_samplingRate(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
