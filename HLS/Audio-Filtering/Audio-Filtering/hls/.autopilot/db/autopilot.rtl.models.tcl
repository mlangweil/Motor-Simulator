set SynModuleInfo {
  {SRCNAME sin_or_cos<float>_Pipeline_1 MODELNAME sin_or_cos_float_Pipeline_1 RTLNAME calculateCoefficients_sin_or_cos_float_Pipeline_1
    SUBMODULES {
  ...
  {SRCNAME sin_or_cos<float>_Pipeline_2 MODELNAME sin_or_cos_float_Pipeline_2 RTLNAME calculateCoefficients_sin_or_cos_float_Pipeline_2}
  {SRCNAME sin_or_cos<float> MODELNAME sin_or_cos_float_s RTLNAME calculateCoefficients_sin_or_cos_float_s
    SUBMODULES {
      {MODELNAME calculateCoefficients_mul_23s_22ns_45_1_1 RTLNAME calculateCoefficients_mul_23s_22ns_45_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME calculateCoefficients_mul_30s_29ns_58_1_1 RTLNAME calculateCoefficients_mul_30s_29ns_58_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME calculateCoefficients_mul_80s_24ns_80_1_1 RTLNAME calculateCoefficients_mul_80s_24ns_80_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME calculateCoefficients_sparsemux_17_3_1_1_1 RTLNAME calculateCoefficients_sparsemux_17_3_1_1_1 BINDTYPE op TYPE sparsemux IMPL auto}
      {MODELNAME calculateCoefficients_sparsemux_33_4_1_1_1 RTLNAME calculateCoefficients_sparsemux_33_4_1_1_1 BINDTYPE op TYPE sparsemux IMPL auto}
      {MODELNAME calculateCoefficients_mul_15ns_15ns_30_1_1 RTLNAME calculateCoefficients_mul_15ns_15ns_30_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME calculateCoefficients_mul_15ns_15s_30_1_1 RTLNAME calculateCoefficients_mul_15ns_15s_30_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
  ...
  {SRCNAME calculateCoefficients_Pipeline_VITIS_LOOP_23_2 MODELNAME calculateCoefficients_Pipeline_VITIS_LOOP_23_2 RTLNAME calculateCoefficients_calculateCoefficients_Pipeline_VITIS_LOOP_23_2}
  {SRCNAME calculateCoefficients MODELNAME calculateCoefficients RTLNAME calculateCoefficients IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME calculateCoefficients_regslice_both RTLNAME calculateCoefficients_regslice_both BINDTYPE interface TYPE adapter IMPL reg_slice}
    }
  }
}
