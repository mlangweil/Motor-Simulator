...
entity calculateCoefficients_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity calculateCoefficients_regslice_both;

architecture behave of calculateCoefficients_regslice_both is
